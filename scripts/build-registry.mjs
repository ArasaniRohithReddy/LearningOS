...
const SKILL_RULES = [
  ...
  ["Data & analytics", /(data-pipeline|streaming-pipeline|dbt-model|dashboard-designer|data-quality|spark-job|power-bi|dax|excel-formula|data-warehouse|cdc-pipeline|data-catalog|airflow-dag|data-contract|lakehouse|snowflake-performance|unity-catalog)/],
  ...
  ["Backend & systems", /(caching-strategy|rate-limiter|message-queue|database-index|concurrency-coach|microservices|webhook|idempotency|saga-pattern|event-sourcing|api-pagination|graphql-schema|grpc|cqrs|circuit-breaker|retry-backoff)/],
  ...
  ["Career & communication", /(resume|star-story|portfolio|slide|demo-script|case-study|cover-letter|linkedin|salary|whiteboard|coding-interview|data-interview|frontend-interview|pm-interview|sre-interview|offer-evaluation)/],
