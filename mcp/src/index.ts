...
async function main() {
  ...
  server.registerTool(
    "search_skills",
    {
      ...
      description:
        "Search the 519 LearningOS skills (labs, coaches, drills) by keyword and/or domain. Returns matching skill names, one-line descriptions, and domains. Follow up with get_skill to load a skill's full instructions.",
