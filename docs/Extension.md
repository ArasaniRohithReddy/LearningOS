...
> - **CLI:** `code --install-extension extension/learningos-drona-1.2.0.vsix`
> - **UI:** VS Code → Extensions view → **⋯** → **Install from VSIX…** → pick the file.


| Host / tool | Install this | How |
|---|---|---|
| **VS Code** | `extension/learningos-drona-1.2.0.vsix` | `code --install-extension extension/learningos-drona-1.2.0.vsix` — or Extensions view → ⋯ → **Install from VSIX…** |
| **VS Code Insiders** | same `.vsix` | `code-insiders --install-extension extension/learningos-drona-1.2.0.vsix` |
