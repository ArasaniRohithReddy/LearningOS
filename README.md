...
&nbsp;·&nbsp; **129 agents · 779 skills · 122 roles**
...
| [Platforms](docs/Platforms.md) | **Individual-level** cross-platform setup (Claude Code/Desktop, Cursor, Gemini, M365 Cowork) — zip import, per-host MCP wiring, **opt-in** Azure CLI auth |
...
LearningOS includes **361 hands-on labs** (`*-lab` skills) so you learn by doing — per language
...
orchestrator, shared constitution, **779 skills**, **129 agents** (Drona + 6 mentors + 122 role-agents),
...
- **Breadth toward 100+ agents / 500+ skills** — added in reviewed, high-quality batches across every
  domain (each is one role config or one skill folder; no stubs). *129 agents / 779 skills and counting.*
