...
&nbsp;·&nbsp; **129 agents · 718 skills · 122 roles**
...
- **129 agents · 718 skills · 122 role configs** — Drona routes to specialist mentors and reusable `/`-skills across every technical domain.
...
- **336 no-subscription labs** + run code in **90+ languages** with nothing installed; practice **AWS / Azure / GCP / Oracle** locally via [floci](docs/Floci.md).
...
flowchart TD
    ...
    subgraph Skills["718 Reusable Skills — invoke with /"]
...
│   ├── skills/                    # 718 reusable workflows (slash commands), across 27 groups
...
LearningOS includes **336 hands-on labs** (`*-lab` skills) so you learn by doing — per language
...
orchestrator, shared constitution, **718 skills**, **129 agents** (Drona + 6 mentors + 122 role-agents),
...
- **Breadth toward 100+ agents / 500+ skills** — added in reviewed, high-quality batches across every
  domain (each is one role config or one skill folder; no stubs). *129 agents / 718 skills and counting.*
